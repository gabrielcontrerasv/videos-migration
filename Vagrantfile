...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "comfama" do |comfama|
    comfama.vm.hostname = settings['vm_hostname']
    comfama.vm.network :"public_network", bridge: settings['public_bridge'], ip: settings['public_ip']
